...
The objective of this project is to learn the fundamental concepts of multi-tenancy. I used Docker, Nginx, and Flask to identify tenants through subdomains and HTTP headers.
